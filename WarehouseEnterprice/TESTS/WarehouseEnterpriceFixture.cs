...
public class WarehouseEnterpriceFixture
{
    public List<Organization> Organizations =
        ...
        new() {Id = 3, Name = "Valve", Address = "Bellevue, Washington"},
    ...
    public WarehouseEnterpriceFixture()
    {
        ...
        Supplies =
        [
        new() { Id = 0, Product = Products[0], Organization = Organizations[0], Quantity = 10, SupplyDate = new DateTime(2021, 5, 10) }, 
        new() { Id = 1, Product = Products[1], Organization = Organizations[1], Quantity = 20, SupplyDate = new DateTime(2022, 12, 1) }, 
        new() { Id = 2, Product = Products[2], Organization = Organizations[2], Quantity = 15, SupplyDate = new DateTime(2020, 8, 15) }, 
        ...
        new() { Id = 5, Product = Products[5], Organization = Organizations[5], Quantity = 25, SupplyDate = new DateTime(2019, 3, 28) }, 
        new() { Id = 6, Product = Products[6], Organization = Organizations[6], Quantity = 12, SupplyDate = new DateTime(2020, 4, 5) }, 
        new() { Id = 7, Product = Products[7], Organization = Organizations[7], Quantity = 8, SupplyDate = new DateTime(2019, 11, 14) }, 
        new() { Id = 8, Product = Products[8], Organization = Organizations[0], Quantity = 18, SupplyDate = new DateTime(2021, 7, 22) }, 
        new() { Id = 9, Product = Products[9], Organization = Organizations[1], Quantity = 14, SupplyDate = new DateTime(2022, 1, 30) }, 
        new() { Id = 10, Product = Products[10], Organization = Organizations[2], Quantity = 50, SupplyDate = new DateTime(2023, 3, 15) } 
        ];
    }
}