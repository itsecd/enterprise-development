    ...
    private void InitializeHRData()
    {
        ...
        HRData.Employees = new List<Employee>
        {
            new Employee
            {
                ...
                Position = new Position { Id = 1, Name = "Software Engineer" },
                Departments = new List<Department> { new Department { Id = 1, Name = "HR Department" } }
            },
            new Employee
            {
                Id = 2,
                ...
                Position = new Position { Id = 2, Name = "Marketing Specialist" },
                Departments = new List<Department> { new Department { Id = 2, Name = "IT Department" } }
            },
            new Employee
            {
                Id = 3,
                ...
                Position = new Position { Id = 3, Name = "Financial Analyst" },
                Departments = new List<Department> { new Department { Id = 3, Name = "Marketing Department" } }
            },
            new Employee
            {
                Id = 4,
        ...
        {
            new WorkHistory { Id = 1, Employee = HRData.Employees.First(e => e.Id == 1), Department = HRData.Departments.First(d => d.Id == 1), Position = HRData.Positions.First(p => p.Id == 1), StartDate = new DateTime(2010, 1, 1), EndDate = new DateTime(2014, 1, 1) },
            new WorkHistory { Id = 2, Employee = HRData.Employees.First(e => e.Id == 2), Department = HRData.Departments.First(d => d.Id == 2), Position = HRData.Positions.First(p => p.Id == 2), StartDate = new DateTime(2012, 1, 1), EndDate = new DateTime(2018, 1, 1) },
            new WorkHistory { Id = 3, Employee = HRData.Employees.First(e => e.Id == 3), Department = HRData.Departments.First(d => d.Id == 3), Position = HRData.Positions.First(p => p.Id == 3), StartDate = new DateTime(2015, 1, 1), EndDate = new DateTime(2020, 1, 1) },
            new WorkHistory { Id = 4, Employee = HRData.Employees.First(e => e.Id == 4), Department = HRData.Departments.First(d => d.Id == 2), Position = HRData.Positions.First(p => p.Id == 2), StartDate = new DateTime(2017, 1, 1), EndDate = new DateTime(2020, 1, 1) },
            new WorkHistory { Id = 5, Employee = HRData.Employees.First(e => e.Id == 5), Department = HRData.Departments.First(d => d.Id == 3), Position = HRData.Positions.First(p => p.Id == 3), StartDate = new DateTime(2020, 1, 1), EndDate = new DateTime(2022, 1, 1) },
        };
