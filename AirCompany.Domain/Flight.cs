...
/// <param name="departureTime">Время отправления рейса.</param>
/// <param name="duration">Продолжительность рейса.</param>
    ...
    List<Passenger> passengers)
{
    ...
    /// </summary>
    public TimeSpan DepartureTime { get; set; } = departureTime;
