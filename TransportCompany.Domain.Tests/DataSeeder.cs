...
public static class DataSeeder
{
    ...
    public static List<Trip> GetTrips(List<Vehicle> vehicles, List<Driver> drivers, List<Client> clients) => new()
    {
        ...
        new Trip { Id = 2, DriverId = 2, VehicleId = 2, ClientId = 2, Driver = drivers[2], Vehicle = vehicles[2], Client = clients[2], Date = DateTime.Now.AddDays(-10), CargoWeight = 20.0, TransportationCost = 18000m, Status = TripStatus.Planned },
        new Trip { Id = 3, DriverId = 3, VehicleId = 3, ClientId = 3, Driver = drivers[3], Vehicle = vehicles[3], Client = clients[3], Date = DateTime.Now.AddDays(-5), CargoWeight = 8.5, TransportationCost = 9000m, Status = TripStatus.Completed },
        new Trip { Id = 4, DriverId = 4, VehicleId = 4, ClientId = 4, Driver = drivers[4], Vehicle = vehicles[4], Client = clients[4], Date = DateTime.Now.AddDays(-2), CargoWeight = 25.0, TransportationCost = 22000m, Status = TripStatus.InTransit },
        new Trip { Id = 5, DriverId = 5, VehicleId = 5, ClientId = 5, Driver = drivers[5], Vehicle = vehicles[5], Client = clients[5], Date = DateTime.Now.AddDays(1), CargoWeight = 10.0, TransportationCost = 11000m, Status = TripStatus.Planned },
        new Trip { Id = 6, DriverId = 6, VehicleId = 6, ClientId = 6, Driver = drivers[6], Vehicle = vehicles[6], Client = clients[6], Date = DateTime.Now.AddDays(3), CargoWeight = 18.5, TransportationCost = 16500m, Status = TripStatus.Planned },
        new Trip { Id = 7, DriverId = 7, VehicleId = 7, ClientId = 7, Driver = drivers[7], Vehicle = vehicles[7], Client = clients[7], Date = DateTime.Now.AddDays(-8), CargoWeight = 22.0, TransportationCost = 20000m, Status = TripStatus.Completed },
        new Trip { Id = 8, DriverId = 8, VehicleId = 8, ClientId = 8, Driver = drivers[8], Vehicle = vehicles[8], Client = clients[8], Date = DateTime.Now.AddDays(-1), CargoWeight = 14.0, TransportationCost = 13500m, Status = TripStatus.InTransit },
        new Trip { Id = 9, DriverId = 9, VehicleId = 9, ClientId = 9, Driver = drivers[9], Vehicle = vehicles[9], Client = clients[9], Date = DateTime.Now.AddDays(-2), CargoWeight = 13.0, TransportationCost = 12500m, Status = TripStatus.InTransit }
    };
}
